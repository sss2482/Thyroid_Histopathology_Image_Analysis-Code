...
for i in range(10):
    ...
    FAC_capsule=os.listdir(path+"/content/FA_capsule")
    print("Total images in FA_capsule ",len(FAC_capsule))
    ...
    # plt.show()
    plt.savefig('/workspace/storage/results/densenet/'+dt_string+' capsule_accuracy')
    plt.show()
    ...
    plt.legend(['train', 'test'], loc='upper left')
    # plt.show()
    plt.savefig('/workspace/storage/results/densenet/'+dt_string+' capsule_loss')
    plt.show()
