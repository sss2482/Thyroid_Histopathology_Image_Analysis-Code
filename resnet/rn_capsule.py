...
for i in range(10):
    ...
    root_dir_ptc=os.listdir(path+"/content/PTC_capsule/")
    ...
    root_dir_fa=os.listdir(path+"/content/FA_capsule/")
    ...
    root_dir_niftp=os.listdir(path+"/content/NIFTP capsule")
    ...
    for i in FA_capsule:
        image=tf.keras.preprocessing.image.load_img(path+"/content/FA_capsule/"+i, color_mode='rgb',
        target_size= (112, 112))
    ...
    for i in NIFTP_capsule:
        image=tf.keras.preprocessing.image.load_img(path+"/content/NIFTP capsule/"+i, color_mode='rgb',
        target_size= (112, 112))
        image=np.array(image)
        if i.split("_")[0] in train_id:
    ...
    for i in PTC_capsule:
        image=tf.keras.preprocessing.image.load_img(path+"/content/PTC_capsule/"+i, color_mode='rgb',
        target_size= (112, 112))
        image=np.array(image)
        if i.split("_")[0] in train_id:
            ptc_train.append(i)
    ...
    # plt.show()
    plt.savefig('/workspace/storage/results/densenet/'+dt_string+' resnet_capsule_accuracy')
    plt.show()
    ...
    plt.legend(['train', 'test'], loc='upper left')
    # plt.show()
    plt.savefig('/workspace/storage/results/densenet/'+dt_string+' resnet_capsule_loss')
    plt.show()
    ...
    results_df.to_excel('/workspace/storage/results/densenet/resnet_capsule_results'+dt_string+'.xlsx')
