...
for i in range(10):
    ...
    # plt.show()
    plt.savefig('/workspace/storage/results/densenet/'+dt_string+' resnet_nodule_accuracy')
    plt.show()
    ...
    plt.legend(['train', 'test'], loc='upper left')
    # plt.show()
    plt.savefig('/workspace/storage/results/densenet/'+dt_string+' resnet_nodule_loss')
    plt.show()
    ...
    results_df.to_excel('/workspace/storage/results/densenet/resnet_nodule_results'+dt_string+'.xlsx')
